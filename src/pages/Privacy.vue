<template>
  <q-page class="flex flex-center">
    ...
    <p>
      Nikolas Haag built the Habit league app as a Free app. This SERVICE is
      provided by Nikolas Haag at no cost and is intended for use as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at Habit league unless otherwise
    ...
    <p>
      ...
      not limited to name, surname, email address. The information that I
      request will be retained on your device and is not collected by me in any
      way.
    </p>
    <p>
    ...
    <p>
      ...
      hesitate to contact me at nikolashaag+habitleague@gmail.com.
    </p>
  </q-page>
</template>
