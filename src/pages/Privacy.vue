<template>
  <q-page class="privacy-policy flex flex-center">
    <div class="text-container">
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Habit league unless
      ...
      <p>
        ...
        but not limited to name, surname, email address. The information that I
